...
export async function GET() {
  ...
  const body = [
    "# CappaWork",
    "",
    "> CappaWork helps businesses over ~$50 million in revenue implement AI and agents. Primary offer: 6-Week AI Transformation. Engagement investment is scoped after a Computer Work Audit.",
    "",
    "## What CappaWork Does",
    "",
    ...
    "## Best Fit",
    "",
    "- Businesses over ~$50M in annual revenue (operators, founders, executives)",
    ...
    "",
    "- One department, 2–4 workflows, production in six weeks",
    ...
    "- Billing process: 50% at signature, 50% at go-live (no net-30 on the back half); engagement amount quoted after audit",
    ...
    "## Other Offers",
    "",
    `- Discover (Computer Work Audit $2,500; longer Discover scopes available): ${base}/discover`,
    `- Build (discrete product sprint — internal or external products; workflow AI in one department is usually Transformation): ${base}/build`,
    `- Modernize retainer (optional after Transformation): unlimited fixes on shipped work + one new workflow/month — ${base}/modernize`,
    "",
    "## Cohorts & AI Training",
    "",
