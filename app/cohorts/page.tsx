...
export const metadata: Metadata = {
  ...
  description:
    "Two live cohorts for directors, VPs, and CXOs. AI Literacy Bootcamp for strategic fluency. AI for Business Leaders to ship a real workflow.",
  openGraph: {
    title: "AI Cohorts for Business Leaders | CappaWork",
    description:
