...
const DIAGNOSTIC_TEMPLATE: TierTemplate = {
  phases: [
    ...
    { name: "Current State", order: 1 },
    { name: "Future State", order: 2 },
    { name: "Delivery", order: 3 },
  ],
  tasks: {
    "Discovery": [
      { title: "Kickoff call", description: "Align on goals, concerns, timeline, and what success looks like" },
      { title: "Access & credentials handoff", description: "Provide access to financial systems, P&L, CRM, tools, and any reporting" },
      { title: "Software stack & tools inventory", description: "List of all tools, subscriptions, and integrations currently in use" },
      { title: "Architecture diagram / tech stack review", description: "Map current technical infrastructure, integrations, and data flows" },
      { title: "Founder deep-dive interview (60 min)", description: "Deep dive with founder on biggest pain points and growth goals" },
      { title: "Schedule stakeholder interviews (3–5)", description: "Schedule interviews with key team members across functions" },
      { title: "Stakeholder interviews", description: "Conduct 3–5 interviews on workflows, bottlenecks, and time sinks" },
      { title: "Data pull requests & collection", description: "Request and collect all relevant data exports, reports, and documents" },
    ],
    "Current State": [
      { title: "P&L deep dive (trailing 24 months)", description: "Analyze revenue, COGS, margins, and expense trends over time" },
      { title: "Revenue segmentation by customer/service/channel", description: "Break down revenue by customer, product/service, channel, and geography" },
      { title: "Margin decomposition by segment", description: "Identify which segments are profitable and which are margin-negative" },
      { title: "Revenue per employee benchmarking", description: "Benchmark current efficiency and model path to scale" },
      { title: "End-to-end workflow mapping (lead → cash → delivery)", description: "Map core business processes from lead to cash to delivery to support" },
      { title: "Time allocation analysis (value-add vs. admin/manual)", description: "Estimate how team time splits across value-add vs. manual/admin work" },
      { title: "Bottleneck & queue identification", description: "Pinpoint where work stalls, queues, or requires manual intervention" },
      { title: "Data quality assessment", description: "Evaluate state of client's data — completeness, accuracy, accessibility" },
      { title: "Progress check-in with founder", description: "Brief update to founder on emerging themes — no deliverable yet" },
    ],
    "Future State": [
      { title: "Automation & AI opportunity identification", description: "List every process that could be automated, AI-assisted, or eliminated" },
      ...
      { title: "Quick wins identification (<1 week, outsized impact)", description: "Flag anything that can be fixed in under 1 week with outsized impact" },
      { title: "Risk & dependency mapping", description: "Identify what blocks what — sequencing constraints and prerequisites" },
      { title: "Software stack cost & ROI analysis", description: "Total spend, per-user cost, overlap, and ROI assessment" },
      { title: "Future-state architecture recommendation", description: "Recommended technical architecture and tooling for optimized operations" },
      { title: "Implementation roadmap draft (phased with timelines & costs)", description: "Phased plan with timelines, costs, and expected ROI per initiative" },
    ],
    "Delivery": [
      { title: "Draft diagnostic report with executive summary", description: "Compile findings into structured deliverable with executive summary" },
      { title: "Internal review & QA (verify numbers, pressure-test recs)", description: "Verify all numbers, pressure-test recommendations, refine narrative" },
      { title: "Final report design & formatting", description: "Polish deliverable for client presentation" },
      { title: "Diagnostic readout — live presentation (60–90 min)", description: "Live session walking through findings, opportunities, and roadmap" },
      { title: "Final report delivered (PDF + supporting data)", description: "Final written deliverable — PDF + supporting data" },
      { title: "Q&A follow-up session (within 1 week)", description: "Scheduled within 1 week of readout for follow-up questions" },
