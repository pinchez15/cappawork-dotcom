...
export function ProspectChat() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("/api/admin/prospects/parse", {
        method: "POST",
      ...
      >
        <div className="relative">
          <textarea
            ...
            placeholder={'Paste a company website, LinkedIn page, or just describe the company.\n\ne.g. "https://acmestaffing.com" or "Acme Staffing, Austin TX, ~$5M, staffing & recruiting"'}
            rows={4}
