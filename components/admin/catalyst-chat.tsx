...
export function CatalystChat() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("/api/admin/catalysts/parse", {
        method: "POST",
      ...
      >
        <div className="relative">
          <textarea
            ...
            placeholder={'Describe a catalyst, paste a LinkedIn profile, or just drop a name and role.\n\ne.g. "Mike Johnson, CPA at Johnson Group, met at a networking event"'}
            rows={4}
